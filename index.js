...
function listOfNames(arr) {
  let newArr = []
  arr.forEach((artists, idx) =>{
    newArr[idx] = artists.name
  })
  return newArr;
}
...
function removeArtist(arr, idx) {
  let newArr = []
  newArr = arr.filter(artist => artist !== arr[idx])
  return newArr;
}
